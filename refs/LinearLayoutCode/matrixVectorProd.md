...
| . | . |
|$\text{row}_{n_{\text{row}} - 1}$|$\text{term}(i_0)_{\text{row}_{n_{\text{row}} - 1}} \oplus \text{term}(i_1)_{\text{row}_{n_{\text{row}} - 1}} \oplus \dots \oplus \text{term}(i_K)_{\text{row}_{n_{\text{row}} - 1}}$|
